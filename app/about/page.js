  ...
  return (
    <>
      <div className="bg-slate-900 text-blue-100 md:p-20 p-5 flex flex-col md:flex-row md:justify-around justify-center relative">
        ...
        <div className=''>
          <div className="bg-slate-900 h-75 md:w-120 w-full rounded-2xl mb-7 overflow-scroll text-blue-200 about-card-shadow">
          ...
          <div className="bg-slate-900 h-75 md:w-120 w-full rounded-2xl mb-7 overflow-scroll text-blue-200 about-card-shadow">
            ...
            <div className="p-4 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-5 place-items-center">
              {[
          ...
          <div className="bg-slate-900 h-75 md:w-120 w-full rounded-2xl mb-7 md:overflow-hidden overflow-scroll text-blue-200 about-card-shadow">
            ...
            <ul className='text-lg p-4 mx-5 list-disc flex flex-col gap-5'>
              ...
              <li className='flex justify-between'>
                <div>
                  ...
                  <p className=''>Full stack Web Development | 2023-24</p>
                </div>
              ...
              <li className='flex justify-between'>
                <div>
                  ...
                  <p className=''>Basics of Ethical Hacking | 2024-25</p>
                </div>
