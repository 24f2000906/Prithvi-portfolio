        ...
        <div className='md:flex justify-around md:px-20 py-20'>
          <div className="text-blue-200">
            ...
            <div className='flex items-center md:justify-start justify-around text-2xl'>
              <svg className='bg-slate-900 text-blue-200 blue-shadow cursor-pointer w-13 h-13 border-2 p-2 mx-1 md:ml-5' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
              ...
              <svg className='bg-slate-900 text-blue-200 blue-shadow cursor-pointer w-13 h-13 border-2 p-2 mx-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
          ...
          <div className='flex justify-center mt-10 md:mt-0'>
            <img className='rounded-full w-70 h-90' src="me.png" alt="prithvi" />
          </div>
        </div>
