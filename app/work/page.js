    ...
    <>
        <div className="bg-transparent text-blue-100 sm:p-20 pt-7">
            ...
            <div className="flex flex-wrap md:gap-3 gap-1 justify-around">
                <a href='https://web3-psi-puce.vercel.app/pricing' className="h-60 w-90 flex justify-center cursor-pointer items-center animate__animated animate__zoomInUp transition-5">
                ...
                <a href='https://web3-psi-puce.vercel.app/' className="h-60 w-90 flex justify-center cursor-pointer items-center animate__animated animate__zoomInUp transition-5">
                  <div className="absolute bg-blue-200 opacity-20 rounded-2xl h-54 w-81 md:h-60 md:w-90"></div>
                  <img src="portfolio.png" className='h-45 w-80 z-10 rounded-md' />
                </a>
                <a href='https://timeelectric.in' className="h-60 w-90 flex justify-center cursor-pointer items-center animate__animated animate__zoomInUp transition-5">
                  <div className="absolute bg-blue-200 opacity-20 rounded-2xl h-54 w-81 md:h-60 md:w-90"></div>
